...
fetchData(null, (data) => {
  ...
  ingredientLines.map((ingredient) => {
    ingredientItems += ` <li class="ignr-item">
       ${ingredient}
      </li>`;
  });
  ...
  $detailContainer.innerHTML = `
    ...
    <img src="${bannerUrl}" width="${width}" height="${height}" alt="${title}" loading="lazy" class="img-cover" />
  </figure>
  ...
  <div class="detail-content">
    ...
    <div class="details-author label-large">
    ...
    <div class="detail-stats">
      ...
      <div class="stats-item">
        ...
        <span class="label-medium">${
          getTime(cookingTime).timeUnit || "<1"
        }</span>
      </div>
      <div class="stats-item">
  ...
  ${
    ...
    <h2 class="title-medium ingr-title">
      Ingredients <span class="label-small">for ${servings} Servings</span>
    </h2>  

    ${
      ingredientItems
        ? `<ul class="body-large ignr-list">
        ${ingredientItems}
        </ul>`
        : ""
    }
